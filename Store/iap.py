"""Fairway Ledger Pro: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.fairwayledger.pro"
NAME = "Fairway Ledger Pro"
PRICE = "4.99"
DESCRIPTION = "The full stat book and spreadsheet export."  # 55 chars max
REVIEW_NOTE = (
    "Non-consumable, one-time unlock. The app is free; practice logging, the journal, scorecards, "
    "the handicap estimate, the yardage book and the last-ten-rounds averages are free forever. Pro unlocks "
    "the full stat book on the Stats tab (score trend, putting by distance, ball flight, practice mix, weekly "
    "minutes) and spreadsheet export. To see the paywall: open the Stats tab and tap See Fairway Ledger Pro, "
    "or tap the lock on the Export the ledger card at the bottom of the Stats tab. Restore purchase is on the "
    "paywall and on the Pro card at the bottom of the Home tab."
)
